...
int main() {
	...
	cout << "Array after adding a new number: " << endl; output(a, size);

	// adding a duplicate number to array
	// the function should not add it
	addNumber(a, 20., size);
	cout << "Array after adding existing number: " << endl; output(a, size);
	
	//
	removeNumber(a, 10., size);
	cout << "Array after removing number: " << endl; output(a, size);
